# WEB103 Project 4 - *Sneaker Personalizer*

Submitted by: **Rashad Landrum**

About this web app: **Make a sneaker**
...
![alt text](sneaker_personalizer.gif)
...
This would be better if we made the project from scratch instead of forking an old one.
